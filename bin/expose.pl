...
# Changelog:
#  2003-11-16 cantsinrpshowall.sh
#  2003-11-19 variousMisc. fixes to rpshowall
#  2003-11-20 twbexpose.pl
#  2003-11-20 cantsinrpshowallminor changes
#  2003-11-22 twbexposenew algorithm, broke script
#  2004-05-21 bkhlposted on wiki
#  2004-06-22 twbexposenewfull rewrite, changelog started
#  2004-06-24 twbexposenewfullrelease candidate
#  2004-07-07 twbexposenewfullreleasetoggle logic for fselect (line 43)
#  2005-07-05 ivanupdated for the new fdump format (works with 1.4.0-beta4)
...
# ratpoison -c info returns something like this:
# (1021,760) 6(Rxterm)
#            ^ this is the number we want
my $current_window = &rpi('info'); chomp $current_window;
#nested parens (1 level). Vim for example (53, 142) 2(expose.pl + (~/bin) - GVIM1) 
#edited by kidd Sun Feb 18 04:16:25 CET 2007
$current_window =~ s/\([^()]*(\([^()]*\)[^()]*)*\)| //g;  
printf("$current_window\n");
&rp("frestore $frames_old");
&rp("select $current_window");
