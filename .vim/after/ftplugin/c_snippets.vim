...
"home Made Snippets: BOOST"
exec "Snippet fore BOOST_FOREACH(".st.et."){<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet test bool ".st."fun".et."()<CR>{<CR>cout << \"".st."fun".et."\"<< endl;<CR>".st.et."<CR>}<CR>".st.et
